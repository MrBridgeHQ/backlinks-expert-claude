...
visibility, and a natural-looking link profile. It just doesn't pass ranking equity - so file it as a *traffic/brand* play, not a *ranking* play, and never overstate it.
...
**Reject if** spam score is high, or the page sits in an obviously toxic neighborhood - a link from a bad neighborhood is a liability, especially for a money site.
...
- A site whose traffic graph fell off a cliff (a metric job often shows this) -   possible Google penalty.
